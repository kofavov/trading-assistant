...
public class NewCurrency {
    private static final Map<String, NewCurrency> CURRENCY_MAP = new TreeMap<>();
    private String id;
    private String name;
    ...
    static {
        try {
            ...
            CURRENCY_MAP.put("USD", new NewCurrency(CurrencyEnum.USD));
            CURRENCY_MAP.put("EUR", new NewCurrency(CurrencyEnum.EUR));
            CURRENCY_MAP.put("TRY", new NewCurrency(CurrencyEnum.TRY));
        }
    }
    public NewCurrency(CurrencyEnum currencyEnum) {
    ...
    public NewCurrency(String id, String name, String engName, Integer nominal,
    ...
    private static void fillMap() throws Exception {
        ...
        for (int i = 0; i < curElements.getLength(); i++) {
            ...
            NewCurrency currency = getNewNewCurrency(nodeList, id);
            CURRENCY_MAP.put(currency.getISO_Char_Code(), currency);
        }
    }

    private static NewCurrency getNewNewCurrency(NodeList nodeList, String id) {
        ...
        String parentCode = "";
        String engName = "";
        return new NewCurrency(id, name, engName, nominal, parentCode, ISO_Num_Code, ISO_Char_Code);
    }
    ...
    public static Map<String, NewCurrency> getCurrencyMap() {
        return CURRENCY_MAP;
    }
    ...
    public boolean equals(Object o) {
        ...
        NewCurrency currency = (NewCurrency) o;
